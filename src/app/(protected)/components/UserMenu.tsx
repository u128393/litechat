  ...
  return (
    <DropdownMenu>
      ...
      >
        ...
        <span className="flex-1 truncate text-[14px] text-[var(--lc-text-primary)]">{currentUser.email}</span>
      ...
      >
        {/* Theme toggle */}
        <DropdownMenuItem
          className="flex cursor-pointer items-center gap-2 rounded-md px-3 py-2 text-[14px] text-[var(--lc-text-primary)]"
          onClick={() => {
