...
export const messagesByLocale: Record<AppLocale, AppMessages> = {
  en: {
    ...
    chat: {
      ...
      heroDescription: "Pick a model, keep drafts locally, and continue from recoverable streaming replies.",
  ...
  "zh-CN": {
    ...
    chat: {
      ...
      timelineLabel: "时间线",
      emptyState: "准备好了，随时开始",
      heroTitle: "在共享工作区中开始一段对话。",
      heroDescription: "选择一个模型，在本地保留草稿，并在可恢复的流式回复中继续交流。",
