...
import { MobileModelSelector } from "@/features/chat/components/MobileModelSelector";
import { ConversationExportMenu } from "@/features/chat/components/ConversationExportMenu";
...
export function ProtectedShell({ currentUser, initialSidebarCollapsed, children }: ProtectedShellProps) {
  ...
  const [shortcutPlatform] = useState<"mac" | "other">(() => {
